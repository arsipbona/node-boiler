class DataTable {
    ...
    //     limit = `LIMIT ${parseInt(this.request.start)},${parseInt(this.request.length)}`;
    //   }
    ...
    async order() {
      ...
      if (await this.request.order.length > 0) {
        ...
        this.request.order.forEach((element, index) => {
          ...
          if (await requestColumn["orderable"] == "true") {
            let dir =
            ...
            this.db.query(
              ...
              (err, resultCount, columns) => {
                ...
                let output = {
                  ...
                  data: DataTable.mapData(this.columns, results)
                };
